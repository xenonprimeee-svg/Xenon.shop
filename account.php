...
<head>
  ...
  <title>Xylo Hacks | Account Settings</title>
...
(function markActiveNav(){
  ...
  <main class="flex-1 overflow-y-auto p-4 md:p-6 space-y-4 md:space-y-6">
    <section class="glass-card rounded-[26px] p-5 md:p-8">
      ...
      <h1 class="text-3xl md:text-4xl font-extrabold text-white mb-3">Account Settings</h1>
      <p class="text-white/70 text-base md:text-lg max-w-3xl mb-6">Create a polished destination for profile preferences, account controls, and personal store settings.</p>
      <div class="flex flex-wrap gap-3">
        ...
        <div class="flex items-start gap-3">
          <i class="bi bi-person-gear text-xl text-violet-300"></i>
          <div>
            <h2 class="text-lg font-semibold text-white mb-1">Profile settings</h2>
            <p class="text-white/65">Manage your account details, preferences, and personal information after signing in.</p>
          </div>
        </div>
      </article>
            <article class="glass-card rounded-3xl p-5">
        <div class="flex items-start gap-3">
          <i class="bi bi-sliders text-xl text-violet-300"></i>
          <div>
            <h2 class="text-lg font-semibold text-white mb-1">Store preferences</h2>
            <p class="text-white/65">Update your account settings and keep your Xylo Store experience personalized and organized.</p>
          </div>
        </div>
      </article>
          </section>
