...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0, shrink-to-fit=no">
      <link rel="icon" type="image/png" href="/favicon.png?v=1778657662"><title>Xylo Hacks | Register</title>
...
<body class="login-shell text-gray-100 min-h-screen flex flex-col relative overflow-hidden">
    ...
    <div id="splashScreen">
        <div class="text-center">
            ...
            <div class="splash-text">CREATE ACCOUNT</div>
    ...
    <div class="container mx-auto px-4 relative z-10 w-full flex-1 flex items-center justify-center">
        <div class="max-w-md w-full mx-auto">
            <div class="glass login-card rounded-xl p-6 animate-fade-in relative overflow-hidden">
                ...
                <div class="relative z-10">
                    <div class="text-center mb-3">
                        <h3 class="text-2xl font-bold text-white mb-1 bg-gradient-to-r from-accent to-accent2 bg-clip-text text-transparent">Create Account</h3>
                        <p class="text-gray-500 text-xs">Sign up to continue</p>
                    </div>
                    ...
                    <form method="POST" autocomplete="on" class="space-y-3">
                        <div class="group">
                            ...
                            <div class="relative">
                                <input type="text" 
                                       class="login-input border border-white/5 rounded-lg p-2.5 w-full bg-transparent text-white placeholder-gray-600 focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent/20 input-focus-effect pl-9 text-sm" 
                                       name="username" 
                                       id="username" 
                        ...
                        <div class="group">
                            <label for="email" class="block text-gray-500 text-xs mb-1 transition-colors group-focus-within:text-accentLight">
                        ...
                        <div class="group">
                            <label for="confirm_password" class="block text-gray-500 text-xs mb-1 transition-colors group-focus-within:text-accentLight">
                                <i class="bi bi-lock-fill mr-1"></i>Confirm Password
                            </label>
                            <div class="relative">
                                <input type="password" 
                                       class="login-input border border-white/5 rounded-lg p-2.5 w-full bg-transparent text-white placeholder-gray-600 focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent/20 input-focus-effect pl-9 text-sm" 
                        ...
                        <button type="submit" class="w-full bg-gradient-to-r from-accent to-accent2 hover:from-accentLight hover:to-accent text-white py-2.5 rounded-lg font-medium transition-all duration-300 btn-hover-effect relative overflow-hidden group mb-2 text-sm xylo-primary-btn">
                            <span class="relative z-10 flex items-center justify-center">
                                <i class="bi bi-person-plus mr-1.5 group-hover:translate-x-1 transition-transform"></i>Register
                            </span>
                        </button>
                                        <p class="text-[11px] leading-relaxed text-white/55 mt-2 text-center">By creating an account, you agree to our <a href="/terms" class="text-accentLight hover:text-accent underline underline-offset-2">Terms of Service</a> and <a href="/privacy" class="text-accentLight hover:text-accent underline underline-offset-2">Privacy Policy</a>.</p>
</form>
                    
                    <div class="text-center space-y-2 mt-3">
                        <a href="login.php" class="block text-accentLight hover:text-accent transition-all duration-300 font-medium text-xs group xylo-auth-link">
