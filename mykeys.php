...
<head>
  ...
  <title>Xylo Hacks | My Keys</title>
  ...
  <main class="flex-1 overflow-y-auto p-4 md:p-6 space-y-4 md:space-y-6">
    <section class="glass-card rounded-[26px] p-5 md:p-8">
      <div class="inline-flex items-center gap-2 rounded-full border border-emerald-400/35 bg-emerald-500/10 px-4 py-2 text-sm font-semibold text-emerald-200 mb-5">
        ...
        Access your product keys      </div>
      <h1 class="text-3xl md:text-4xl font-extrabold text-white mb-3">My Keys</h1>
      <p class="text-white/70 text-base md:text-lg max-w-3xl mb-6">Provide a clean destination for product keys, activation details, and quick access essentials in the Xylo Store experience.</p>
      <div class="flex flex-wrap gap-3">
        ...
        <div class="flex items-start gap-3">
          <i class="bi bi-key text-xl text-violet-300"></i>
          <div>
            <h2 class="text-lg font-semibold text-white mb-1">Product access</h2>
            <p class="text-white/65">Find your digital keys, activation details, and access information after signing in to your account.</p>
          </div>
        </div>
      </article>
            <article class="glass-card rounded-3xl p-5">
        <div class="flex items-start gap-3">
          <i class="bi bi-safe text-xl text-violet-300"></i>
          <div>
            <h2 class="text-lg font-semibold text-white mb-1">Secure delivery</h2>
            <p class="text-white/65">Return anytime to view the product information connected to your completed purchases.</p>
          </div>
        </div>
      </article>
          </section>
