  ...
  <main class="flex-1 overflow-y-auto p-4 md:p-6 space-y-4 md:space-y-6">
    <section class="glass-card rounded-[26px] p-5 md:p-8">
      <div class="inline-flex items-center gap-2 rounded-full border border-emerald-400/35 bg-emerald-500/10 px-4 py-2 text-sm font-semibold text-emerald-200 mb-5">
        ...
        Manage your purchases      </div>
      <h1 class="text-3xl md:text-4xl font-extrabold text-white mb-3">Orders</h1>
      <p class="text-white/70 text-base md:text-lg max-w-3xl mb-6">Give customers a clear destination for current orders, delivery progress, and purchase follow-up across Xylo Store.</p>
      <div class="flex flex-wrap gap-3">
        ...
        <div class="flex items-start gap-3">
          <i class="bi bi-receipt text-xl text-violet-300"></i>
          <div>
            <h2 class="text-lg font-semibold text-white mb-1">Your orders</h2>
            <p class="text-white/65">Check your active purchases, completed orders, and recent transactions in one place.</p>
          </div>
        </div>
      </article>
            <article class="glass-card rounded-3xl p-5">
        <div class="flex items-start gap-3">
          <i class="bi bi-box-seam text-xl text-violet-300"></i>
          <div>
            <h2 class="text-lg font-semibold text-white mb-1">Delivery progress</h2>
            <p class="text-white/65">Track fulfillment updates and review the next steps for any order tied to your account.</p>
          </div>
        </div>
      </article>
          </section>
